...
; (function (name, context, factory) {
  ...
  //  start mery fankareya 


  // var canvasProps = document.createElement('canvas');
  // var canvasContext = canvasProps.getContext('2d');
  ...
  // $(canvasProps).on('wheel', function (ev) {
  ...
  // $(canvasProps).on('mousedown', function (ev) {
  //   is_down = true
  //   is_drag = false
  //   last_drag = { x: ev.clientX, y: ev.clientY }
  // })

  // $(canvasProps).on('mousemove', function (ev) {
  //   is_drag = true
  ...
  // $(canvasProps).on('mouseup', function (ev) {
  //   is_down = false
  //   last_drag = null
  ...
  // $(canvasProps).css({ position: 'absolute', top: 0, left: 0 }).appendTo(document.body)

  // function animate () {
  //   window.requestAnimationFrame(animate)

  //   canvasContext.clearRect(0, 0, canvasProps.width, canvasProps.height)
